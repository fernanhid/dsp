...
<pre>
<i>Frequentist statistics</i> views data as long run frequencies with which events occur, therefore, 
...
<i>Bayesian statistics</i> on the other hand, treats the data as fixed and derives the underlying 
